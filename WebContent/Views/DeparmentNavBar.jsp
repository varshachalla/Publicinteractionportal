...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="deptHead.do">Public Interaction Portal</a>
    ...
    <button class="btn btn-danger navbar-btn" id="update">Update</button>
    </div>
